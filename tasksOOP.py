...
best_student_1 = Student('Алексей', 'Иванов', 'м')
best_student_2 = Student('Ольга', 'Петровна', 'ж')
...
reviewer_homeworks_1 = Reviewer('Питон', 'Питонычь')
reviewer_homeworks_2 = Reviewer('Ява', 'Скриптизёр')
...
lector_course_1 = Lecturer('Си', 'Шарпович')
lector_course_2 = Lecturer('Вим', 'Мастер')
